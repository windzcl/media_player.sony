...
* **Asynchronous Architecture:** Fully refactored to use `async/await` and `DataUpdateCoordinator`, preventing blocking calls that slow down Home Assistant.
...
3. Paste the URL of this repository: `https://github.com/windzcl/media_player.sony`
4. Select **Integration** as the category and click **Add**.
5. Find "Sony Legacy API (Custom)" in HACS and click **Download**.
6. **Restart Home Assistant**.

### Manual
1. Copy the `custom_components/sony_custom/` folder to your `/custom_components/` directory.
...
2. Click **Add Integration** and search for **Sony Legacy API**.
3. Enter the **IP Address** of your device.
4. Follow the on-screen instructions to enter the **PIN** shown on your Sony device.

> **Note:** The device must be on the same subnet as your Home Assistant instance. For better stability, it is highly recommended to enable **"Remote Start"** (Inicio Remoto) in your Sony device settings.
